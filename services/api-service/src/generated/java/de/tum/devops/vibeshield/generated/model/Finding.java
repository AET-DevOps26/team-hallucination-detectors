...
/**
 * A single security issue discovered by a scan.
 */

@Schema(name = "Finding", description = "A single security issue discovered by a scan.")
...
public class Finding {
   ...
   */
  public Finding(Long id, Long scanId, ScanCheck check, String title, Severity severity, String affected, String explanation, String suggestedFix, FindingStatus status) {
    this.id = id;
    this.scanId = scanId;
    this.check = check;
    this.title = title;
  ...
  public Finding scanId(Long scanId) {
    this.scanId = scanId;
    return this;
  }
  ...
  public Finding check(ScanCheck check) {
    this.check = check;
    return this;
  }
  ...
  public Finding affected(String affected) {
    this.affected = affected;
    return this;
  }
  ...
  public Finding explanation(String explanation) {
    this.explanation = explanation;
    return this;
  }
  ...
  public Finding suggestedFix(String suggestedFix) {
    this.suggestedFix = suggestedFix;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, finding.id) &&
        Objects.equals(this.scanId, finding.scanId) &&
        Objects.equals(this.check, finding.check) &&
        Objects.equals(this.title, finding.title) &&
        Objects.equals(this.severity, finding.severity) &&
        Objects.equals(this.affected, finding.affected) &&
        Objects.equals(this.explanation, finding.explanation) &&
        Objects.equals(this.suggestedFix, finding.suggestedFix) &&
        Objects.equals(this.status, finding.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, scanId, check, title, severity, affected, explanation, suggestedFix, status);
  }
