...
FIX_PROMPT_SYSTEM = (
    ...
    "{builder_guidance}\n\n"
    "Optional grounding context from vetted security references, which may say "
    "'(none)':\n"
    "{retrieved_context}\n\n"
    "If this context is present, use it to inform your severity rationale and, "
    "where it fits naturally, name the source (e.g. \"per OWASP A05:2021\"). If "
    "it says '(none)', proceed using only the finding details below — do not "
